...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              ...
              _context.p = 1;
              _context.n = 2;
              return Nova.request().get('/nova-vendor/purchase-value/total-usd');
            case 2:
              res = _context.v;
              _this.labels = res.data.labels || [];
              _this.requested = (res.data.requested || []).map(function (v) {
                return Number(v);
              });
              _this.approved = (res.data.approved || []).map(function (v) {
                return Number(v);
              });
              _this.remaining = (res.data.remaining || []).map(function (v) {
                return Number(v);
              });
              _context.n = 3;
            ...
            case 4:
              ...
              _t = _context.v;
              console.error(_t);
              _this.error = (_t === null || _t === void 0 || (_e$response = _t.response) === null || _e$response === void 0 || (_e$response = _e$response.data) === null || _e$response === void 0 ? void 0 : _e$response.message) || _t.message || 'Request failed';
            case 5:
              _context.p = 5;
              _this.loading = false;
              return _context.f(5);
    ...
    renderChart: function renderChart() {
      ...
      if (!canvas) return;
      if (this.chart) this.chart.destroy();
      this.chart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](canvas.getContext('2d'), {
        type: 'line',
        data: {
          labels: this.labels,
          datasets: [{
            ...
            tooltip: {
              callbacks: {
                label: function label(item) {
                  return " ".concat(Number(item.raw || 0).toLocaleString(), " $");
                }
              }
            }
          },
...
var _hoisted_1 = {
  "class": "px-3 py-3 bg-gray-200 rounded-2xl!"
};
var _hoisted_2 = {
  key: 0,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, "قيمة المشتريات"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    "class": "text-xs text-gray-500"
  }, "آخر 15 أيام (USD)")], -1 /* CACHED */)), $data.error ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_2, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.error), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("canvas", _hoisted_4, null, 512 /* NEED_PATCH */), $data.loading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_5, " Loading... ")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]);
}
...
Nova.booting(function (app, store) {
  app.component('purchase-value', _components_Card__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkshaden_serafa_purchase_value"] = self["webpackChunkshaden_serafa_purchase_value"] || [];
